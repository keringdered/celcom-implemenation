...
print_r($balance);*/
/*get delivery report*/
/*$delivery = $gateway->delivery_report(98597370);
print_r($delivery);*/

/*send message*/
/*$message = $gateway->send("254715404451","Message from a refactored class using get method");
print_r($message);
$message =  $gateway->send("254715404451","Message from a refactored class using POST method");
print_r($message);*/
